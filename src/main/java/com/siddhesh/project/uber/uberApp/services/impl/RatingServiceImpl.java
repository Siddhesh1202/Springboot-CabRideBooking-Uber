...
import com.siddhesh.project.uber.uberApp.entities.Rating;
...
import com.siddhesh.project.uber.uberApp.repositories.RatingRepository;
import com.siddhesh.project.uber.uberApp.repositories.RiderRepository;
import com.siddhesh.project.uber.uberApp.services.RatingService;
...
public class RatingServiceImpl implements RatingService {
    ...
    public DriverDto rateDriver(Ride ride, Integer rating) {
        ...
        Rating ratingObj = ratingRepository.findByRide(ride).orElseThrow(() -> new ResourceNotFoundException("Ride Not Found"));
